  ...
  <div class="col-8">
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade show active" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
       <p class=" bg" id="aia"><b>PM Kishan Yojana</b></p>
      ...
      <p class=" bg" id="aia"><b>Assistance schemes for farming</b></p>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
       <p class=" bg" id="aia"><b>Industry Projects of the Ministry of Food Processing</b></p>
      ...
      <p class=" bg" id="aia"><b>Krushi Amal Sahay</b></p>
       <img src="assets/pic/ks.jpg" id="image"></img>

      </div>
      <div class="tab-pane fade" id="list-status" role="tabpanel" aria-labelledby="list-status-list">
       <p class=" bg" id="aia"><b>Check your status</b></p>
...
<h5>Enter your village number</h5>
        ...
        <input type="submit" name="search" style="font-weight:bold;background-color:rgb(45, 224, 21)">
</form>
...
function change_district(){
    var xmlhttp= new XMLHttpRequest();
    xmlhttp.open("GET","ajax.php?district1="+document.getElementById("districtdd").value,false);
    xmlhttp.send(null);
...
function change_subdistrict(){
    var xmlhttp= new XMLHttpRequest();
    xmlhttp.open("GET","ajax.php?subdistrict1="+document.getElementById("subdistrictdd").value,false);
    xmlhttp.send(null);
...
function change_block(){
    var xmlhttp= new XMLHttpRequest();
    xmlhttp.open("GET","ajax.php?block1="+document.getElementById("blockdd").value,false);
    xmlhttp.send(null);
...
function change_village(){
    var xmlhttp= new XMLHttpRequest();
    xmlhttp.open("GET","ajax.php?village1="+document.getElementById("villagedd").value,false);
    xmlhttp.send(null);
